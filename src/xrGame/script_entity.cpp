...
//			Msg			("%6d Processing action : %s",EngineInterface->GetRoundedGlobalTime(),*l_tpEntityAction->m_tAnimationAction.m_caAnimationToPlay);
#endif
...
#ifdef _DEBUG
//		if (!xr_strcmp("m_stalker_wounded",*object().cName()))
//			Msg			("%6d Action completed : %s",EngineInterface->GetRoundedGlobalTime(),*l_tpEntityAction->m_tAnimationAction.m_caAnimationToPlay);
#endif
...
#ifdef _DEBUG
//				Msg									("%6d Starting sound %s",EngineInterface->GetRoundedGlobalTime(),*l_tSoundAction.m_caSoundToPlay);
#endif
...
//			Msg			("%6d Object %s, position [%f][%f][%f]",EngineInterface->GetRoundedGlobalTime(),*l_tpGameObject->cName(),VPUSH(l_tpGameObject->Position()));
...
#ifdef DEBUG
			//if (!xr_strcmp("m_stalker_wounded",*object().cName()))
			//	Msg				("%6d Playing animation : %s , Object %s",EngineInterface->GetRoundedGlobalTime(),*GetCurrentAction()->m_tAnimationAction.m_caAnimationToPlay, *object().cName());
#endif
