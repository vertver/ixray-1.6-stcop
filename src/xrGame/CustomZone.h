...
{
	SZoneObjectInfo():object(NULL),zone_ignore(false),dw_time_in_zone(0),f_time_affected(EngineInterface->GetGlobalTime()),small_object(false),nonalive_object(false) {}
	CGameObject*			object; 
	bool					small_object;
