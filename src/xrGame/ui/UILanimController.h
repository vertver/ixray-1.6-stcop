...
public:
	...
	{
		m_lanim_clr.m_lanim_start_time = EngineInterface->GetContinualTime()/1000.0f + m_lanim_clr.m_lanim_delay_time/1000.0f;
	}
	virtual bool IsColorAnimationPresent()
	{
		...
		float t = EngineInterface->GetContinualTime()/1000.0f;
