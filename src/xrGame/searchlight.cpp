...
void CProjector::UpdateCL	()
{
	...
	// Update searchlight 
	angle_lerp(_current.yaw,	_target.yaw,	bone_x.velocity, EngineInterface->GetDeltaTime());
	angle_lerp(_current.pitch,	_target.pitch,	bone_y.velocity, EngineInterface->GetDeltaTime());
}
