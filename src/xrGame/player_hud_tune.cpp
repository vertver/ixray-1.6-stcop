...
{
	Fmatrix							cam_m;
	cam_m.i.set						(EngineInterface->GetCameraState().CameraRight);
	cam_m.j.set						(EngineInterface->GetCameraState().CameraTop);
	cam_m.k.set						(EngineInterface->GetCameraState().CameraDirection);
	cam_m.c.set						(EngineInterface->GetCameraState().CameraPosition);
