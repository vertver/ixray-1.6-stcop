...
{
//	Msg									("[%6d][%s] started to build detail path",EngineInterface->GetFrame(),*m_restricted_object->object().cName());
	...
	STOP_PROFILE;
//	Msg									("[%6d][%s] build_detail_path [%d][%d][%d]",EngineInterface->GetFrame(),*m_restricted_object->object().cName(),path().size(),curr_travel_point_index(),last_patrol_point());
}
