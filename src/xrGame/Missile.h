...
public:
	...
	IC		void			set_destroy_time		(u32 delta_destroy_time) {m_dwDestroyTime = delta_destroy_time + EngineInterface->GetRoundedGlobalTime();}
...
public:
	...
	IC		int				time_from_begin_throw	() const { return (EngineInterface->GetRoundedGlobalTime() + m_dwDestroyTimeMax - m_dwDestroyTime); }
