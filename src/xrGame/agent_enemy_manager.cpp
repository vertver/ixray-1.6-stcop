...
//	Msg								("[%6d] assigned = %x",EngineInterface->GetRoundedGlobalTime(),assigned);
//	ENEMIES::iterator				I = m_enemies.begin();
//	ENEMIES::iterator				E = m_enemies.end();
//	for ( ; I != E; ++I)
//		Msg							("[%6d] [%s] = %x",EngineInterface->GetRoundedGlobalTime(),*(*I).m_object->cName(),(*I).m_distribute_mask.get());
}
