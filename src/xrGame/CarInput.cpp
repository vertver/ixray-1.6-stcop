...
/*
	case kFWD:		
		...
		else								m_vCamDeltaHP.y += active_camera->rot_speed.y*EngineInterface->GetDeltaTime();
		break;
	case kBACK:		
	...
	case kL_STRAFE: 
		...
		else								m_vCamDeltaHP.x -= active_camera->rot_speed.x*EngineInterface->GetDeltaTime();
		break;
	case kR_STRAFE: 
