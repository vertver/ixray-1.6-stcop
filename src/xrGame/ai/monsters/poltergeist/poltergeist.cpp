...
void   CPoltergeist::update_detection ()
{
	...
	float const time_passed_sec			=	float(EngineInterface->GetRoundedGlobalTime() - m_last_detection_time) / 1000.f;
	m_last_detection_time				=	EngineInterface->GetRoundedGlobalTime();
