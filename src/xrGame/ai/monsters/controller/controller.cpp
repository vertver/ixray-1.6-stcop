...
/*
	...
	time_control_hit_started	= EngineInterface->GetRoundedGlobalTime();
*/
}
...
void CController::UpdateCL()
{
	...
	if (active_control_fx) {
		...
		float percent		= float((EngineInterface->GetRoundedGlobalTime() - time_control_hit_started)) / float(time_to_show);
		...
		if (percent < TEXTURE_SIZE_PERCENT ) {
			...
			float x1 = EngineInterface->GetWidth()  / 2 - ((EngineInterface->GetWidth() / 2) * percent);
			float y1 = EngineInterface->GetHeight() / 2 - ((EngineInterface->GetHeight() / 2) * percent);
			float x2 = EngineInterface->GetWidth() / 2 + ((EngineInterface->GetWidth() / 2) * percent);
			float y2 = EngineInterface->GetHeight() / 2 + ((EngineInterface->GetHeight() / 2) * percent);
			...
			float x1 = EngineInterface->GetWidth() / 2 - ((EngineInterface->GetWidth() / 2) * percent2);
			float y1 = EngineInterface->GetHeight() / 2 - ((EngineInterface->GetHeight() / 2) * percent2);
			float x2 = EngineInterface->GetWidth() / 2 + ((EngineInterface->GetWidth() / 2) * percent2);
			float y2 = EngineInterface->GetHeight() / 2 + ((EngineInterface->GetHeight() / 2) * percent2);
