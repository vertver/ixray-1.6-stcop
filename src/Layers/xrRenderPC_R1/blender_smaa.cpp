...
void CBlender_SMAA::Compile(CBlender_Compile& C) {
    ...
    case 0:
        ...
        C.r_Sampler_clf("s_image", "$user$rendertarget");
    ...
    case 1:
        ...
        C.r_Sampler("s_edgetex", "$user$edgetex", false, D3DTADDRESS_CLAMP);
    ...
    case 2:
        ...
        C.r_Sampler_clf("s_image", "$user$rendertarget");
        C.r_Sampler("s_blendtex", "$user$blendtex", false, D3DTADDRESS_CLAMP);
