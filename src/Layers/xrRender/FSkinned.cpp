	...
	case RM_SKINNING_1B:
		{
			...
			//R_CHK				(RCache.get_Device()->CreateVertexBuffer(V.vCount*vStride,dwUsage,0,D3DPOOL_MANAGED,&V.p_rm_Vertices,0));
...
#ifndef USE_DX11	//	Don't use hardware buffers in DX10 since we can't read them
	switch	(RenderMode)
	{
	case RM_SKINNING_SOFT:
#endif //USE_DX11
