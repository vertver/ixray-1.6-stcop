...
//	u32	dwUsage				= D3DUSAGE_WRITEONLY;
	...
	// vertices
	{
		...
		u32		vSize		= 3*4;
		//R_CHK	(RCache.get_Device()->CreateVertexBuffer(
		//	vCount*vSize,
		//	dwUsage,
		//	0,
		//	D3DPOOL_MANAGED,
	...
	// Indices
	{
		...
		//BYTE*	pData		= 0;
		//R_CHK				(RCache.get_Device()->CreateIndexBuffer(iCount*2,dwUsage,D3DFMT_INDEX16,D3DPOOL_MANAGED,&g_accum_spot_ib,0));
...
void CRenderTarget::accum_volumetric_geom_create()
{
	...
	// Indices
	{
		...
		//BYTE*	pData		= 0;
		//R_CHK				(RCache.get_Device()->CreateIndexBuffer(iCount*2,dwUsage,D3DFMT_INDEX16,D3DPOOL_MANAGED,&g_accum_volumetric_ib,0));
