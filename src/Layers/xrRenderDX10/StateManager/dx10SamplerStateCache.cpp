...
{
	CHK_DX(RCache.get_Device()->CreateSamplerState( &desc, ppIState));
}
...
void dx10SamplerStateCache::VSApplySamplers(HArray &samplers)
{
	...
	RCache.get_Context()->VSSetSamplers(uiMin, uiMax-uiMin+1, &pSS[uiMin]);
}
...
void dx10SamplerStateCache::PSApplySamplers(HArray &samplers)
{
	...
	RCache.get_Context()->PSSetSamplers(uiMin, uiMax-uiMin+1, &pSS[uiMin]);
}
...
void dx10SamplerStateCache::GSApplySamplers(HArray &samplers)
{
	...
	RCache.get_Context()->GSSetSamplers(uiMin, uiMax-uiMin+1, &pSS[uiMin]);
}
...
void dx10SamplerStateCache::HSApplySamplers(HArray &samplers)
{
	...
	RCache.get_Context()->HSSetSamplers(uiMin, uiMax-uiMin+1, &pSS[uiMin]);
}
...
void dx10SamplerStateCache::DSApplySamplers(HArray &samplers)
{
	...
	RCache.get_Context()->DSSetSamplers(uiMin, uiMax-uiMin+1, &pSS[uiMin]);
}
...
void dx10SamplerStateCache::CSApplySamplers(HArray &samplers)
{
	...
	RCache.get_Context()->CSSetSamplers(uiMin, uiMax-uiMin+1, &pSS[uiMin]);
}
